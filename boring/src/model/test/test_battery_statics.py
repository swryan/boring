...
class TestBatteryStatics(unittest.TestCase):
    ...
    def test_batt_statics_partials(self):
        ...
        from openmdao.core.problem import _ErrorTuple
        ...
        et = _ErrorTuple(forward=analytic_val-check_val, reverse=analytic_val-check_val, forward_reverse=0.0)
